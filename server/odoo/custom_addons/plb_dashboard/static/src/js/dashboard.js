                ...
                <tbody>
                    <t t-if="getFilteredTableRows() &amp;&amp; getFilteredTableRows().length">
                        ...
                        <t t-if="contractRows &amp;&amp; contractRows.length">
                            <tr t-foreach="contractRows" t-as="row" t-key="row.id">
                                ...
                                <td><t t-esc="row.week || '-'"/></td>
                                <td><t t-esc="row.month || '-'"/></td>
                        ...
                        <t t-else="">
                            <tr>
                                <td colspan="23" class="text-center text-muted">No contract stage data available</td>
                            </tr>
                        </t>
                     </t>
                     <t t-else="">
                 ...
                 <tfoot class="plb-footer">
                     ...
                     <tr style="font-weight:700; background:#f8f9fa;">
                         ...
                         <td colspan="9" class="text-end plb-subtotal-no-bottom"><strong>Monthly Subtotal</strong></td>
                     ...
                     <tr style="font-weight:600; background:#ffffff;">
                         <td colspan="9" class="text-end plb-cumulative-no-top"><strong>Cumulative</strong></td>
